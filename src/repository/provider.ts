...
export async function createProvider(providerData: CreateProviderData): Promise<Provider> {
  ...
  const dbData = {
    ...
    modelMismatchAlertExempt: providerData.model_mismatch_alert_exempt ?? false,
  ...
  return db.transaction(async (tx) => {
    ...
    const [provider] = await tx
      ...
      .returning({
        ...
        modelMismatchAlertExempt: providers.modelMismatchAlertExempt,
...
export async function updateProvider(
  ...
  if (providerData.model_mismatch_alert_exempt !== undefined)
    dbData.modelMismatchAlertExempt = providerData.model_mismatch_alert_exempt;
