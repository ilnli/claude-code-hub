...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_avail_bucket_1m_time" ON "avail_bucket_1m" USING btree ("bucket_start" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_outbox_events_unpublished" ON "outbox_events" USING btree ("id") WHERE "outbox_events"."published_at" IS NULL;--> statement-breakpoint
